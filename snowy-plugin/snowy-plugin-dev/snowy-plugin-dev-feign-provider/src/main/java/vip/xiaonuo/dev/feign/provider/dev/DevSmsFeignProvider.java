...
@RestController
public class DevSmsFeignProvider implements DevSmsFeign {

    private final DevSmsApi devSmsApi;
    ...
    public void sendDynamicSms(String phoneNumbers, String templateCodeOrId, JSONObject paramMap) {
        this.devSmsApi.sendDynamicSms(phoneNumbers, templateCodeOrId, paramMap);
    }
    ...
    public void sendSmsAliyun(String phoneNumbers, String signName, String templateCode, String templateParam) {
        this.devSmsApi.sendSmsAliyun(phoneNumbers, signName, templateCode, templateParam);
    }
    ...
    public void sendSmsTencent(String phoneNumbers, String signName, String templateCode, String templateParam) {
        this.devSmsApi.sendSmsTencent(phoneNumbers, signName, templateCode, templateParam);
    }
    ...
    public void sendSmsXiaonuo(String phoneNumbers, String signName, String message) {
        this.devSmsApi.sendSmsXiaonuo(phoneNumbers, signName, message);
    }
}
