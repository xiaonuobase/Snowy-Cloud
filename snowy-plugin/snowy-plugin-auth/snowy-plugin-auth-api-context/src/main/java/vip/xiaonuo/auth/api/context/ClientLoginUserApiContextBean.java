...
public class ClientLoginUserApiContextBean implements SaBaseLoginUserApi {
    ...
    public SaBaseLoginUser createUserWithAccount(String account, String password, String name) {
        return this.clientLoginUserFeign.createUserWithAccount(account, password, name);
    }
    ...
    public SaBaseClientLoginUser createClientUserWithAccount(String account, String password, String name) {
        return this.clientLoginUserFeign.createClientUserWithAccount(account, password, name);
    }
