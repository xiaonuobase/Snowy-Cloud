 ...
 */
package vip.xiaonuo.sys.feign.provider.role;
...
public class SysRoleFeignProvider implements SysRoleFeign {
    ...
    public boolean orgHasRole(@RequestParam(value = "orgIdList",required = false) List<String> orgIdList) {
        return sysRoleApi.orgHasRole(orgIdList);
    }
    ...
    public String roleSelector(@RequestParam(value = "current",required = false) Integer current,
                               @RequestParam(value = "size",required = false) Integer size,
                               @RequestParam(value = "orgId",required = false) String orgId,
                               @RequestParam(value = "category",required = false) String category,
                               @RequestParam(value = "searchKey",required = false) String searchKey,
                               @RequestParam(value = "dataScopeList",required = false)  List<String> dataScopeList,
                               @RequestParam(value = "excludeSuperAdmin",required = false) boolean excludeSuperAdmin) {
        return JSONUtil.toJsonStr(sysRoleApi.roleSelector(orgId, category, searchKey, dataScopeList, excludeSuperAdmin));
    }
    ...
    public List<JSONObject> resourceTreeSelector() {
        return sysRoleApi.resourceTreeSelector();
    }
    ...
    public List<String> permissionTreeSelector() {
        return sysRoleApi.permissionTreeSelector();
    }
}