...
@Component
public class SysRelationApiContextBean implements SysRelationApi {

    private final SysRelationFeign sysRelationFeign;
    ...
    public void removeRoleHasMobileButtonRelation(List<String> targetIdList, List<String> buttonIdList) {
        sysRelationFeign.removeRoleHasMobileButtonRelation(targetIdList, buttonIdList);
    }
}
