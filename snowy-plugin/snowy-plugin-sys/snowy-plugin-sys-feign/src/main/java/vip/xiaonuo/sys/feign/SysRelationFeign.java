...
public interface SysRelationFeign {
    ...
    List<String> getUserIdListByRoleIdList(@RequestParam("initiator") String initiator,
    ...
    List<String> getUserIdListByGroupIdList(@RequestParam("initiator") String initiator,
    ...
    List<String> getGroupIdListByUserIdList(@RequestParam("initiator") String initiator,
