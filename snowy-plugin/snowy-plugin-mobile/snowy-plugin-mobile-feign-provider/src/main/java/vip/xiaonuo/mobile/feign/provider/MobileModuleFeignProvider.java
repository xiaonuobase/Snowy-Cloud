...
@RestController
public class MobileModuleFeignProvider implements MobileModuleFeign {

    final private MobileModuleApi mobileModuleApi;
    ...
    public List<JSONObject> mobileModuleSelector() {
        return this.mobileModuleApi.mobileModuleSelector();
    }
}
