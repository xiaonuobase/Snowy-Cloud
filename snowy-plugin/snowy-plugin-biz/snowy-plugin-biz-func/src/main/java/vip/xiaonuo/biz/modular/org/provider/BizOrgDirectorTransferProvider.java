 ...
 * @date 2026/05/13
 */
@Component("bizOrgDirectorTransferApiProvider")
public class BizOrgDirectorTransferProvider implements SysTransferResourceProvider, BizOrgDirectorTransferApi {
    ...
    public List<JSONObject> getOrgDirectorDetailList(String userId) {
        return getDetailList(userId);
    }

    @Override
    public void executeOrgDirectorTransfer(String sourceUserId, String targetUserId, String transferMode,
                                           boolean transferAll, List<String> selectedIds) {
        executeTransfer(sourceUserId, targetUserId, transferMode, transferAll, selectedIds);
    }
}
