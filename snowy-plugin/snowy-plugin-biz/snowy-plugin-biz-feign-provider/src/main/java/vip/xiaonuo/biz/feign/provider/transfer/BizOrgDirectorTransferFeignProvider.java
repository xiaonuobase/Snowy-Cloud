 ...
 */
package vip.xiaonuo.biz.feign.provider.transfer;
...
@RestController
public class BizOrgDirectorTransferFeignProvider implements BizOrgDirectorTransferFeign {
    ...
    @Override
    public String getOrgDirectorDetailList(String userId) {
        return JSONUtil.toJsonStr(bizOrgDirectorTransferApi.getOrgDirectorDetailList(userId));
    }
