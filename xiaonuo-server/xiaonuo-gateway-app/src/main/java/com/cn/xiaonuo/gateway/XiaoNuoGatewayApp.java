 ...
 */
package com.cn.xiaonuo.gateway;
 ...
 */
@EnableFeignClients(basePackages = "com.cn.xiaonuo.gateway.core.consumer")
@EnableDiscoveryClient
@SpringBootApplication
public class XiaoNuoGatewayApp {
	public static void main(String[] args) {
		SpringApplication.run(XiaoNuoGatewayApp.class, args);
	}
