/*
 ...
 Source Catalog        : snowy-cloud-pub-mssql
 Source Schema         : dbo
...
INSERT INTO [dbo].[SYS_CONFIG] ([ID], [NAME], [CODE], [VALUE], [SYS_FLAG], [REMARK], [STATUS], [GROUP_CODE], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1288310280056483841', N'Oauth码云登录回调地址', N'SNOWY_OAUTH_GITEE_REDIRECT_URI', N'http://127.0.0.1:9005/oauth/callback/gitee', N'Y', N'Oauth码云登录回调地址', N'0', N'OAUTH', N'2020-07-29 11:08:01', N'1265476890672672808', NULL, NULL)
GO
...
INSERT INTO [dbo].[SYS_MENU] ([ID], [PID], [PIDS], [NAME], [CODE], [TYPE], [ICON], [ROUTER], [COMPONENT], [PERMISSION], [APPLICATION], [OPEN_TYPE], [VISIBLE], [LINK], [REDIRECT], [WEIGHT], [SORT], [REMARK], [STATUS], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1264622039642256271', N'1264622039642255961', N'[0],[1264622039642255961],', N'接口文档', N'sys_swagger_mgr', N'1', NULL, N'/swagger', N'Iframe', NULL, N'system', N'2', N'Y', N'http://localhost:9003/doc.html', NULL, N'1', N'13', NULL, N'0', N'2020-07-02 12:16:56', N'1265476890672672808', NULL, NULL)
GO
...
INSERT INTO [dbo].[SYS_MENU] ([ID], [PID], [PIDS], [NAME], [CODE], [TYPE], [ICON], [ROUTER], [COMPONENT], [PERMISSION], [APPLICATION], [OPEN_TYPE], [VISIBLE], [LINK], [REDIRECT], [WEIGHT], [SORT], [REMARK], [STATUS], [CREATE_TIME], [CREATE_USER], [UPDATE_TIME], [UPDATE_USER]) VALUES (N'1264622039642256411', N'1264622039642256351', N'[0],[1264622039642256351],', N'数据监控', N'sys_monitor_mgr_druid', N'1', NULL, N'/druid', N'Iframe', NULL, N'system', N'2', N'Y', N'http://localhost:9101/druid', NULL, N'1', N'18', NULL, N'0', N'2020-06-28 16:15:07', N'1265476890672672808', N'2020-09-13 09:39:10', N'1265476890672672808')
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_APP] ADD CONSTRAINT [PK__SYS_APP__3214EC273A705D07] PRIMARY KEY CLUSTERED ([ID])
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_CODE_GENERATE] ADD CONSTRAINT [PK__SYS_CODE__3214EC27D0CBA5E0] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_CODE_GENERATE_CONFIG] ADD CONSTRAINT [PK__SYS_CODE__3214EC2705978427] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_CONFIG] ADD CONSTRAINT [PK__SYS_CONF__3214EC27091199E8] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_DICT_DATA] ADD CONSTRAINT [PK__SYS_DICT__3214EC27EA5A22B2] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_DICT_TYPE] ADD CONSTRAINT [PK__SYS_DICT__3214EC2704AC45D7] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_EMP] ADD CONSTRAINT [PK__SYS_EMP__3214EC279817B714] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_EMP_EXT_ORG_POS] ADD CONSTRAINT [PK__SYS_EMP___3214EC27619B8A09] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_EMP_POS] ADD CONSTRAINT [PK__SYS_EMP___3214EC2735A7FF34] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_FILE_INFO] ADD CONSTRAINT [PK__SYS_FILE__3214EC27A68A4212] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_MENU] ADD CONSTRAINT [PK__SYS_MENU__3214EC2701FD308D] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_NOTICE] ADD CONSTRAINT [PK__SYS_NOTI__3214EC27FB8C9720] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_NOTICE_USER] ADD CONSTRAINT [PK__SYS_NOTI__3214EC274EBCA7B8] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_OAUTH_USER] ADD CONSTRAINT [PK__SYS_OAUT__3214EC2709C4D8B1] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_OP_LOG] ADD CONSTRAINT [PK__SYS_OP_L__3214EC2768E2A472] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_ORG] ADD CONSTRAINT [PK__SYS_ORG__3214EC2791767F50] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_POS] ADD CONSTRAINT [PK__SYS_POS__3214EC27E75C5EF4] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_ROLE] ADD CONSTRAINT [PK__SYS_ROLE__3214EC27E7F954D8] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_ROLE_DATA_SCOPE] ADD CONSTRAINT [PK__SYS_ROLE__3214EC27A956647C] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_ROLE_MENU] ADD CONSTRAINT [PK__SYS_ROLE__3214EC27A7563E46] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_SMS] ADD CONSTRAINT [PK__SYS_SMS__3214EC2730811E55] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_TIMERS] ADD CONSTRAINT [PK__SYS_TIME__3214EC27C2E26910] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_USER] ADD CONSTRAINT [PK__SYS_USER__3214EC275E5F7294] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_USER_DATA_SCOPE] ADD CONSTRAINT [PK__SYS_USER__3214EC271B335DDC] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_USER_ROLE] ADD CONSTRAINT [PK__SYS_USER__3214EC275E81F2B8] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[SYS_VIS_LOG] ADD CONSTRAINT [PK__SYS_VIS___3214EC27F57CB491] PRIMARY KEY CLUSTERED ([ID])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
