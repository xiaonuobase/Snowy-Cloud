/*
 ...
 Source Catalog        : snowy-cloud-pub
 Source Schema         : dbo
...
INSERT INTO [dbo].[sys_config]  VALUES (N'1280694183769792514', N'druid监控登录账号', N'SNOWY_DRUID_USERNAME', N'superAdmin', N'Y', N'druid监控登录账号', N'0', N'DEFAULT', N'2020-07-08 10:44:22.0000000', N'1265476890672672808', N'2021-02-18 16:18:30.0000000', N'1265476890672672808')
GO

INSERT INTO [dbo].[sys_config]  VALUES (N'1280694281648070658', N'druid监控界面登录密码', N'SNOWY_DRUID_PASSWORD', N'123456', N'Y', N'druid监控登录密码', N'0', N'DEFAULT', N'2020-07-08 10:44:46.0000000', N'1265476890672672808', N'2021-02-18 16:18:36.0000000', N'1265476890672672808')
GO
...
INSERT INTO [dbo].[sys_config]  VALUES (N'1288310280056483841', N'Oauth码云登录回调地址', N'SNOWY_OAUTH_GITEE_REDIRECT_URI', N'http://127.0.0.1:9005/oauth/callback/gitee', N'Y', N'Oauth码云登录回调地址', N'0', N'OAUTH', N'2020-07-29 11:08:01.0000000', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[sys_config]  VALUES (N'1288358228593221633', N'前端项目地址', N'SNOWY_WEB_URL', N'http://localhost:8080', N'Y', N'前端项目地址', N'0', N'DEFAULT', N'2020-07-29 14:18:33.0000000', N'1265476890672672808', NULL, NULL)
GO

INSERT INTO [dbo].[sys_config]  VALUES (N'1288358228593221635', N'是否开启多租户', N'SNOWY_TENANT_OPEN', N'true', N'Y', N'是否开启多租户', N'0', N'DEFAULT', N'2020-09-03 17:45:58.0000000', N'1265476890672672808', N'2021-02-16 00:09:24.0000000', N'1265476890672672808')
GO
...
INSERT INTO [dbo].[sys_menu]  VALUES (N'1264622039642256271', N'1264622039642255961', N'[0],[1264622039642255961],', N'接口文档', N'sys_swagger_mgr', N'1', NULL, N'/swagger', N'Iframe', NULL, N'system', N'2', N'Y', N'http://localhost:9005/doc.html', NULL, N'1', N'13', NULL, N'0', N'2020-07-02 12:16:56.0000000', N'1265476890672672808', NULL, NULL)
GO
...
INSERT INTO [dbo].[sys_menu]  VALUES (N'1264622039642256411', N'1264622039642256351', N'[0],[1264622039642256351],', N'数据监控', N'sys_monitor_mgr_druid', N'1', NULL, N'/druid', N'Iframe', NULL, N'system', N'2', N'Y', N'http://localhost:9005/druid/login.html', NULL, N'1', N'18', NULL, N'0', N'2020-06-28 16:15:07.0000000', N'1265476890672672808', N'2020-09-13 09:39:10.0000000', N'1265476890672672808')
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_app] ADD CONSTRAINT [PK__sys_app__3213E83F3D0C56F7] PRIMARY KEY CLUSTERED ([id])
...
-- ----------------------------
ALTER TABLE [dbo].[sys_code_generate] ADD CONSTRAINT [PK__sys_code__3213E83FCA040A9C] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_code_generate_config] ADD CONSTRAINT [PK__sys_code__3213E83F538B1F79] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_config] ADD CONSTRAINT [PK__sys_conf__3213E83F830ADBA2] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_dict_data] ADD CONSTRAINT [PK__sys_dict__3213E83F9F5AFCA9] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_dict_type] ADD CONSTRAINT [PK__sys_dict__3213E83FB5F3E70F] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_emp] ADD CONSTRAINT [PK__sys_emp__3213E83F157CC085] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_emp_ext_org_pos] ADD CONSTRAINT [PK__sys_emp___3213E83F6F150DC8] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_emp_pos] ADD CONSTRAINT [PK__sys_emp___3213E83F4A4C3AA8] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_file_info] ADD CONSTRAINT [PK__sys_file__3213E83F6790ED58] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_menu] ADD CONSTRAINT [PK__sys_menu__3213E83F776D0DD3] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_notice] ADD CONSTRAINT [PK__sys_noti__3213E83FBACD749A] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_notice_user] ADD CONSTRAINT [PK__sys_noti__3213E83FB563C8B8] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_oauth_user] ADD CONSTRAINT [PK__sys_oaut__3213E83F34D327C3] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_op_log] ADD CONSTRAINT [PK__sys_op_l__3213E83F2E116411] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_org] ADD CONSTRAINT [PK__sys_org__3213E83FBA98032A] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_pos] ADD CONSTRAINT [PK__sys_pos__3213E83FF887F8D0] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_role] ADD CONSTRAINT [PK__sys_role__3213E83F369E7F62] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_role_data_scope] ADD CONSTRAINT [PK__sys_role__3213E83FACAEF960] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_role_menu] ADD CONSTRAINT [PK__sys_role__3213E83FE68C1CE2] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_sms] ADD CONSTRAINT [PK__sys_sms__3213E83F88B5ACD3] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_timers] ADD CONSTRAINT [PK__sys_time__3213E83F6479CC8D] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_user] ADD CONSTRAINT [PK__sys_user__3213E83FB386DB19] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_user_data_scope] ADD CONSTRAINT [PK__sys_user__3213E83FE61F2832] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_user_role] ADD CONSTRAINT [PK__sys_user__3213E83F084B01E7] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[sys_vis_log] ADD CONSTRAINT [PK__sys_vis___3213E83F2CAD6925] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
...
-- ----------------------------
ALTER TABLE [dbo].[xn_code_gen_test] ADD CONSTRAINT [PK__xn_code___3213E83FA8C26160] PRIMARY KEY CLUSTERED ([id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)  
ON [PRIMARY]
GO
